      ...
      <div className="container">
        <div className="section-header center">
          ...
          <p className="section-subtitle">
            Thrill-seekers and leisure lovers alike will find their perfect escape in our range of activities — all set within the natural beauty of AdvaBliss.
          </p>
        </div>
        ...
        <div className="activities__bundle">
          <div className="activities__bundle-content">
            ...
            <div className="activities__bundle-price">
              <span className="activities__bundle-original">kes 2,000</span>
              <span className="activities__bundle-sale">kes 1,500</span>
              <span className="activities__bundle-per">/person</span>
            </div>
