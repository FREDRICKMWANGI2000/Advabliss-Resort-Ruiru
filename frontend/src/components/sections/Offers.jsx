...
import './Offers.css';
import eventsimg from "../images/ziplining.png"
  ...
  return (
    <section id="offers" className="offers section-pad">
      ...
      <div className="container offers__inner">
        ...
        {/* Bottom Banner */}
        <div className="offers__promo-banner">
          <div className="offers__promo-content">
            <span className="offers__promo-emoji">🎁</span>
            <div>
              <h4>Subscribe for Exclusive Deals</h4>
              <p>Be the first to know about new offers, seasonal packages, and member-only discounts.</p>
            </div>
          </div>
          <div className="offers__promo-form">
            <input type="email" className="offers__promo-input" placeholder="Enter your email address" />
