...
import './Hero.css';
import slide1 from "../images/backgroundimg1.png";
import slide2 from "../images/backgroundimg2.png";
import slide3 from "../images/ziplining.png";
...
const SLIDES = [
  ...
  },
  {
    ...
    sub: 'Say "I do" beneath open skies, surrounded by blooming gardens and five-star elegance at AdvaBliss Resort.',
  },
  {
      image: slide3,
    headline: 'Adventures',
    headlineAccent: 'For All Ages',
    sub: 'From thrilling ziplines to peaceful boat rides — discover activities that bring joy to every member of your family.',
  },
];
    ...
    <section id="home" className="hero">
      ...
      <div className="hero__content container">
        ...
        <div className="hero__stats">
          {[['5★', 'Luxury Rating'],['500+', 'Events Hosted'],['50+', 'Acres of Gardens'],['24/7', 'Concierge'],].map(([val, lbl]) => (
