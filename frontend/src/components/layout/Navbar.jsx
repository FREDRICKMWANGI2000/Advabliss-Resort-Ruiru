...
export default function Navbar({ onBookNow }) {
  ...
  />
          ...
          <div className="navbar__actions">
            <a href="tel:+254712345678" className="navbar__tel" aria-label="Call us">
              <Phone size={16} />
      ...
      <div className={`mobile-menu ${menuOpen ? 'mobile-menu--open' : ''}`}>
        ...
        <div className="mobile-menu__footer">
          <button className="btn btn-gold" onClick={() => { onBookNow(); setMenuOpen(false); }}>
            Book Now
          </button>
          <a href="tel:+254712345678" className="mobile-menu__tel">
            <Phone size={15} /> +254 712 345 678
          </a>
        </div>
      </div>
